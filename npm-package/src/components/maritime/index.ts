...
export { CrewCompetencyBadge } from './CrewCompetencyBadge';
export type { CompetencyLevel } from './CrewCompetencyBadge';

export { IncidentSeverityIndicator } from './IncidentSeverityIndicator';
export type { SeverityLevel } from './IncidentSeverityIndicator';
...
export const MARITIME_RANKS = {
  SENIOR_OFFICERS: ['Master', 'Chief Officer', 'Chief Engineer', '2nd Officer', '2nd Engineer'],
  JUNIOR_OFFICERS: ['3rd Officer', '3rd Engineer', '4th Engineer', 'Junior Officer', 'Cadet'],
  RATINGS: [
    'Bosun',
    'AB (Able Seaman)',
    'OS (Ordinary Seaman)',
