...
export const ExampleSAILForm: React.FC<ExampleSAILFormProps> = ({
  ...
  const sections: SAILFormSectionType[] = [
    ...
    },
    {
      ...
      description:
        'Add below at the start of the Appraisal Period except the Evaluation which must be completed at the end of the Appraisal Period',
      content: (
        <div className="space-y-8">
          {/* B1. Trainings Section */}
          <div>
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-base font-medium text-[#16569e]">
            ...
            {tableData.length === 0 ? (
              ...
              <div className="border border-gray-200 border-t-0 rounded-b bg-white">
                {tableData.map((item, index) => (
                  <div
                    key={item.id}
                    className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 p-3 border-b border-gray-100 last:border-b-0"
                  >
